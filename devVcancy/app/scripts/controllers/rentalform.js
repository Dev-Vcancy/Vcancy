							...
							if(vm.draft == "false") {
								if(landlordID != 0) {
									firebase.database().ref('users/'+landlordID).once("value", function(snap) {
										...
										var emailData = '<p>Hello, </p><p>'+applicantname+' has submitted a rental application for '+address+'.</p><p>To view the application, please log in http://www.vcancy.ca/login/#/ and go to “Applications”.</p><p>If you have any questions or suggestions please email us at support@vcancy.ca</p><p>Thanks,</p><p>Team Vcancy</p>';
									...
									var emailData = '<p>Hello, </p><p>'+applicantname+' has submitted an online rental application via vcancy.ca. Please go to this link http://www.vcancy.ca/login/#/viewexternalapp/'+vm.applicationID+' to view the application.</p><p>Check out vcancy.ca http://www.vcancy.ca/login/#/ to automate viewing appointments and compare rental applications	 online.</p><p>For any questions or suggestions please email us at support@vcancy.ca</p><p>Thanks,</p><p>Team Vcancy</p>';
								...
								var emailData = '<p>Hello '+applicantname+', </p><p>Your rental application has been submitted to '+applicantemail+'.</p><p>To make changes, please log in  http://www.vcancy.ca/login/#/ and go to “Applications”.</p><p>If you have any questions or suggestions please email us at support@vcancy.ca</p><p>Thanks,</p><p>Team Vcancy</p>';
